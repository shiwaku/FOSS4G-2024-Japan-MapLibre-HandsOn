...
const map = new maplibregl.Map({
  ...
  center: [139.76703325061217, 35.68117717758896], // マップの初期中心点を指定（経度, 緯度）
  ...
  const overlay = new deck.MapboxOverlay({
    ...
    layers: [
      ...
      new deck.Tile3DLayer({
        ...
        data: "https://assets.cms.plateau.reearth.io/assets/23/bf39db-cd61-4e07-9be3-065a13ddf432/13101_chiyoda-ku_pref_2023_citygml_1_op_bldg_3dtiles_13101_chiyoda-ku_lod2/tileset.json", // 3D TilesのURL
